...
class ContratoCreate(BaseModel):
    ...
    combustivel_entrada: Optional[str] = None
    cartao_tipo: Optional[str] = None
    cartao_numero: Optional[str] = None
    cartao_codigo: Optional[str] = None
    cartao_preaut: Optional[str] = None
    cartao_validade: Optional[str] = None
    cartao_valor: Optional[float] = None
    hora_extra: float = 0
    km_excedente: float = 0
    status: str = "Ativo"
...
class ContratoUpdate(BaseModel):
    ...
    valor_caucao: Optional[float] = None
    subtotal: Optional[float] = None
    avarias: Optional[float] = None
    desconto: Optional[float] = None
    total: Optional[float] = None
    despesas_extras: Optional[float] = None
    combustivel_saida: Optional[str] = None
    combustivel_entrada: Optional[str] = None
    cartao_tipo: Optional[str] = None
    cartao_numero: Optional[str] = None
    ...
    cartao_validade: Optional[str] = None
    cartao_valor: Optional[float] = None
    hora_extra: Optional[float] = None
    km_excedente: Optional[float] = None
