...
import { segurosAPI, veiculosAPI } from '../services/api'
...
const Seguros: React.FC = () => {
  ...
  const seguros: Seguro[] = segurosData?.data || []
        ...
        <table className="w-full">
          <thead className="bg-gray-50 border-b border-gray-200">
            <tr>
              ...
              <th className="px-6 py-3 text-left text-sm font-semibold text-gray-900">Início</th>
